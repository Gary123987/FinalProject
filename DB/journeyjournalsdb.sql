...
INSERT INTO `place` (`id`, `name`, `street`, `zipcode`, `description`, `image_url`, `enabled`, `destination_id`, `user_id`) VALUES (6, 'Red Square', 'Krasnaya ploshchad', '109012', 'Red Square, Russian Krasnaya Ploshchad, open square in Moscow adjoining the historic fortress and centre of government known as the Kremlin (Russian: Kreml). The Kremlin and Red Square were added to UNESCO’s World Heritage List in 1990.\n\nDating from the late 15th century, just after the Kremlin walls were completed, Red Square has long been a focal point in the social and political history of Russia and the former Soviet Union. It has had several names, but the present name has been used consistently since the later 17th century. Always a market area, the square has also housed, at various times, churches, Moscow’s first public library and university, a public theatre, and a printing house.', 'ohc4BB5.jpg%3Fproc%3Dsource%252Ftrip&tbnid=Q-BsL_vEVbqAsM&vet=12ahUKEwiYjJDAqtj_AhVvBFkFHV4vDysQMygpegUIARDRAg..i&imgrefurl=https%3A%2F%2Fwww.trip.com%2Ftravel-guide%2Fattraction%2Fmoscow%2Fred-square-81791%2F&docid=mqoNsmVSl5Fk2M&w=1000&h=667&q=red%20square%20russia&ved=2ahUKEwiYjJDAqtj_AhVvBFkFHV4vDysQMygpegUIARDRAg', 1, 6, 3);
...
INSERT INTO `destination_image` (`id`, `image_url`, `enabled`, `destination_id`, `user_id`, `created_at`, `updated_at`) VALUES (6, 'https://mf.b37mrtl.ru/rbthmedia/images/2020.10/original/5f97a0e915e9f97eb141e7d4.jpg', 1, 6, 3, '2023-06-22 19:50:47', NULL);
...
INSERT INTO `place_image` (`id`, `image_url`, `enabled`, `place_id`, `user_id`, `created_at`, `updated_at`) VALUES (6, 'ohc4BB5.jpg%3Fproc%3Dsource%252Ftrip&tbnid=Q-BsL_vEVbqAsM&vet=12ahUKEwiYjJDAqtj_AhVvBFkFHV4vDysQMygpegUIARDRAg..i&imgrefurl=https%3A%2F%2Fwww.trip.com%2Ftravel-guide%2Fattraction%2Fmoscow%2Fred-square-81791%2F&docid=mqoNsmVSl5Fk2M&w=1000&h=667&q=red%20square%20russia&ved=2ahUKEwiYjJDAqtj_AhVvBFkFHV4vDysQMygpegUIARDRAg', 1, 6, 3, '2023-06-10 12:12:32', NULL);
...
INSERT INTO `blog_category` (`category_id`, `blog_id`) VALUES (7, 6);
