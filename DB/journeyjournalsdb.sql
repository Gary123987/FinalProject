...
INSERT INTO `place` (`id`, `name`, `street`, `zipcode`, `description`, `image_url`, `enabled`, `destination_id`, `user_id`) VALUES (11, 'The Walk of Fame', '6834 Hollywood Blvd. ', '96106', 'The Hollywood Walk of Fame is a historic landmark which consists of more than 2,700 five-pointed terrazzo and brass stars embedded in the sidewalks along 15 blocks of Hollywood Boulevard and three blocks of Vine Street in Hollywood, California. The stars are permanent public monuments to achievement in the entertainment industry, bearing the names of a mix of actors, directors, producers, musicians, theatrical/musical groups, fictional characters, and others.\n\nThe Walk of Fame is administered by the Hollywood Chamber of Commerce, who hold the trademark rights, and maintained by the self-financing Hollywood Historic Trust. It is a popular tourist attraction, with an estimated 10 million annual visitors in 2010.', 'https://a.cdn-hotels.com/gdcs/production36/d108/408bdddc-2a55-49ab-89c1-cc4546026060.jpg?impolicy=fcrop&w=1600&h=1066&q=medium', 1, 1, 1);
INSERT INTO `place` (`id`, `name`, `street`, `zipcode`, `description`, `image_url`, `enabled`, `destination_id`, `user_id`) VALUES (12, 'Santa Monica', '3RD STREET PROMENADE', '90401', 'Santa Monica  is a city in Los Angeles County, situated along Santa Monica Bay on California\'s South Coast. Santa Monica\'s 2020 U.S. Census population was 93,076. Santa Monica is a popular resort town, owing to its climate, beaches, and hospitality industry. It has a diverse economy, hosting headquarters of companies such as Hulu, Universal Music Group, Lionsgate Films, and The Recording Academy.  Santa Monica traces its history to Rancho San Vicente y Santa Mónica, granted in 1839 to the Sepúlveda family of California. The rancho was later sold to John P. Jones and Robert Baker, who in 1875, along with his Californio heiress wife Arcadia Bandini de Stearns Baker, founded Santa Monica, which incorporated as a city in 1886. The city developed into a seaside resort during the late 19th and early 20th centuries, with the creation of tourist attractions such as Palisades Park, the Santa Monica Pier, Ocean Park, and the Hotel Casa del Mar.', 'https://www.planetware.com/wpimages/2023/05/california-los-angeles-top-attractions-santa-monica-bike-path-palms.jpg', 1, 1, 1);
INSERT INTO `place` (`id`, `name`, `street`, `zipcode`, `description`, `image_url`, `enabled`, `destination_id`, `user_id`) VALUES (13, 'Taronga Zoo', 'Bradleys Head Rd', '2088', 'Taronga Zoo is a zoo located in Sydney, New South Wales, Australia, in the suburb of Mosman, on the shores of Sydney Harbour. The opening hours are between 9:30 a.m. to 4:30 p.m. Taronga is an Aboriginal word meaning \"beautiful view\".\n\nIt was officially opened on 7 October 1916. Taronga Zoo Sydney is managed by the Zoological Parks Board of New South Wales, under the trading name Taronga Conservation Society, along with its sister zoo, the Taronga Western Plains Zoo in Dubbo.\n\nDivided into various zoogeographic regions, the 28-hectare (69-acre) Taronga Zoo Sydney is home to more than 2,600 animals of approximately 250 different species. It has a zoo shop, a cafe, and an information centre.', 'https://i.guim.co.uk/img/media/b3121d3048e54f35ff1e7ec83b4822ccd4989856/0_67_5568_3341/master/5568.jpg?width=1300&quality=45&dpr=2&s=none', 1, 4, 2);
INSERT INTO `place` (`id`, `name`, `street`, `zipcode`, `description`, `image_url`, `enabled`, `destination_id`, `user_id`) VALUES (14, 'Saint Basil\'s Cathedral', 'Red Square', '109012', 'The Cathedral of Vasily the Blessed, commonly known as Saint Basil\'s Cathedral, is an Orthodox church in Red Square of Moscow, and is one of the most popular cultural symbols of Russia. The building, now a museum, is officially known as the Cathedral of the Intercession of the Most Holy Theotokos on the Moat, or Pokrovsky Cathedral. It was built from 1555 to 1561 on orders from Ivan the Terrible and commemorates the capture of Kazan and Astrakhan. It was the city\'s tallest building until the completion of the Ivan the Great Bell Tower in 1600.\n\nThe original building, known as Trinity Church and later Trinity Cathedral, contained eight chapels arranged around a ninth, central chapel dedicated to the Intercession; a tenth chapel was erected in 1588 over the grave of the venerated local saint Vasily. In the 16th and 17th centuries, the church, perceived (as with all churches in Byzantine Christianity) as the earthly symbol of the Heavenly City, was popularly known as the \"Jerusalem\" and served as an allegory of the Jerusalem Temple in the annual Palm Sunday parade attended by the Patriarch of Moscow and the Tsar.\n\nThe cathedral has nine domes and is shaped like the flame of a bonfire rising into the sky. Dmitry Shvidkovsky, in his book Russian Architecture and the West, states that \"it is like no other Russian building. Nothing similar can be found in the entire millennium of Byzantine tradition from the fifth to the fifteenth century ... a strangeness that astonishes by its unexpectedness, complexity and dazzling interleaving of the manifold details of its design. \"The cathedral foreshadowed the climax of Russian national architecture in the 17th century.', 'https://gallerybyzantium.com/wp-content/uploads/2019/01/st-basil-cathedral_1.jpg', 1, 6, 3);
INSERT INTO `place` (`id`, `name`, `street`, `zipcode`, `description`, `image_url`, `enabled`, `destination_id`, `user_id`) VALUES (15, 'Table Mountain', 'Table Mountain (Nature Reserve), Cape Town, South Africa', '7824', 'Table Mountain is a flat-topped mountain forming a prominent landmark overlooking the city of Cape Town in South Africa. It is a significant tourist attraction, with many visitors using the cableway or hiking to the top. Table Mountain National Park is the most visited national park in South Africa, attracting 4.2 million people every year for various activities. The mountain has 8,200 plant species, of which around 80% are fynbos, meaning fine bush. It forms part of the Table Mountain National Park, and part of the lands formerly ranged by Khoe-speaking clans, such as the !Uriǁʼaes (the \"High Clan\"). It is home to a large array of mostly endemic fauna and flora.', 'https://cdn.audleytravel.com/1050/750/79/435256-view-from-the-table-mountain-cable-car-cape-town.webp', 1, 11, 3);
...
INSERT INTO `blog` (`id`, `title`, `description`, `trip_start`, `trip_end`, `image_url`, `created_at`, `updated_at`, `enabled`, `user_id`, `place_id`) VALUES (11, 'Unveiling Legends: My Journey on the Historic Walk of Fame in Hollywood', 'The Walk of Fame in Hollywood, a legendary stretch of sidewalk adorned with stars honoring the biggest names in entertainment, is a pilgrimage site for cinephiles and dreamers alike. I recently had the opportunity to wander along this iconic boulevard, where the glitz and glamour of the film industry come to life. Join me as I recount my unforgettable visit to the Walk of Fame, where the spirits of Hollywood\'s legends continue to shine brightly.\n\nStepping onto Hallowed Ground:\nAs I set foot on the Walk of Fame, a palpable sense of excitement filled the air. The sidewalks were lined with bronze stars, each bearing the name and symbol of a beloved figure from the world of entertainment. From the pioneers of silent cinema to the modern-day icons who grace our screens, the Walk of Fame pays homage to the diverse talents that have left an indelible mark on the industry.\n\nStrolling through Hollywood\'s Tapestry:\nWandering along the boulevard, I found myself immersed in the rich tapestry of Hollywood\'s history. The stars on the Walk of Fame are organized into distinct categories, including motion pictures, television, music, radio, and live theater. This arrangement allowed me to explore the contributions of individuals from various realms of the entertainment world, making my journey all the more diverse and intriguing.\n\nIcons etched in Bronze:\nAmong the countless stars that dotted the Walk of Fame, I discovered the names of Hollywood\'s most revered icons. Each star tells a story, capturing the essence of a performer\'s legacy. From Humphrey Bogart and Audrey Hepburn to contemporary stars like Leonardo DiCaprio and Jennifer Lawrence, the Walk of Fame serves as a permanent tribute to the individuals who have captured our hearts and imagination.\n\nHonoring Diversity and Representation:\nOne of the most inspiring aspects of the Walk of Fame is its commitment to celebrating diversity and representation. The stars not only showcase the achievements of mainstream actors and musicians but also pay tribute to pioneers and trailblazers from underrepresented communities. It was heartening to witness the recognition of talents from different cultures and backgrounds, reminding me of the importance of inclusivity in the entertainment industry.\n\nA Source of Inspiration:\nWalking amidst the stars, I couldn\'t help but feel a surge of inspiration. The Walk of Fame serves as a reminder that dreams can come true with dedication, hard work, and a touch of luck. The journey to Hollywood\'s sidewalks may be arduous, but the stars\' stories of triumph and perseverance echoed in my mind, fueling my own aspirations and reaffirming the power of pursuing one\'s passion.\n\nConclusion:\nVisiting the Walk of Fame in Hollywood was a truly enchanting experience. The legacy of Hollywood\'s legends continues to captivate the hearts of visitors from around the world, reminding us of the enduring magic of cinema and the indomitable spirit of those who shape it. As I left the Walk of Fame, I carried with me a renewed appreciation for the entertainment industry and a profound sense of gratitude for the performers who have inspired and entertained us throughout the decades. The Walk of Fame is more than a tourist attraction; it\'s a testament to the enduring power of storytelling and the eternal allure of Hollywood\'s brightest stars.', '2023-06-16', '2023-06-17', 'https://a.cdn-hotels.com/gdcs/production36/d108/408bdddc-2a55-49ab-89c1-cc4546026060.jpg?impolicy=fcrop&w=1600&h=1066&q=medium', '2023-06-21 11:11:11', NULL, 1, 1, 11);
INSERT INTO `blog` (`id`, `title`, `description`, `trip_start`, `trip_end`, `image_url`, `created_at`, `updated_at`, `enabled`, `user_id`, `place_id`) VALUES (12, 'Exploring the Coastal Charm: My Journey through Long Beach, CA', 'Nestled along the stunning Southern California coast, Long Beach is a vibrant city brimming with cultural diversity, natural beauty, and a laid-back beach town atmosphere. I recently had the pleasure of visiting this coastal gem and was immediately captivated by its unique blend of urban attractions and seaside allure. Join me as I share my unforgettable experiences and highlights from my journey through the charming city of Long Beach.\n\nThe Majestic Queen Mary:\nMy first stop was the legendary Queen Mary, an ocean liner-turned-hotel that has become an iconic symbol of Long Beach. Stepping aboard this majestic vessel, I was transported back in time to an era of elegance and luxury. Exploring the historic decks, I discovered fascinating exhibits, elegant dining options, and even a ghost tour for the more adventurous. The Queen Mary offers a captivating glimpse into the golden age of transatlantic travel and is a must-visit attraction for history buffs and maritime enthusiasts.\n\nStroll along the Scenic Shoreline:\nLong Beach boasts a stunning shoreline that stretches for miles, offering breathtaking views of the Pacific Ocean. The city\'s sandy beaches provide the perfect setting for a leisurely walk, sunbathing, or even engaging in water sports. One highlight of my visit was a stroll along the Long Beach Boardwalk, lined with picturesque palm trees and dotted with vibrant street performers. The refreshing ocean breeze and the sound of crashing waves created a serene and relaxing atmosphere.\n\nThe Enchanting Aquarium of the Pacific:\nLocated in the heart of Long Beach, the Aquarium of the Pacific is a captivating destination that showcases the wonders of marine life. With its diverse array of exhibits, including vibrant coral reefs, playful sea otters, and awe-inspiring sharks, the aquarium offers an immersive experience for visitors of all ages. I was particularly enthralled by the mesmerizing jellyfish exhibit and the interactive touch pools, where I had the opportunity to get up close and personal with fascinating marine creatures.\n\nExplore the Lively Downtown and East Village Arts District:\nLong Beach\'s vibrant downtown area is a hub of activity, filled with trendy shops, eclectic restaurants, and lively nightlife. Pine Avenue, the city\'s main thoroughfare, is lined with a diverse range of dining options, from local eateries serving up fresh seafood to international cuisines that cater to every palate. Meanwhile, the East Village Arts District is a haven for art enthusiasts, boasting numerous galleries, studios, and street murals that celebrate the city\'s thriving artistic community.\n\nHistoric Charm of Naples Island:\nLocated in the Alamitos Bay, Naples Island is a picturesque neighborhood known for its enchanting canals and charming waterfront homes. Taking a leisurely gondola ride through the canals was a highlight of my visit, providing a unique perspective and a sense of tranquility. The area is also home to charming boutiques and cozy cafes, making it an ideal place to explore on foot and soak in the ambiance of this hidden gem within Long Beach.\n\nConclusion:\nMy visit to Long Beach was a delightful blend of coastal beauty, cultural exploration, and a laid-back atmosphere. From the enchanting Queen Mary to the lively downtown scene and the serenity of the Naples Island canals, the city offers a diverse range of experiences for every traveler. Long Beach\'s unique charm, warm hospitality, and stunning coastal setting make it a destination that should not be missed for those seeking a memorable and rejuvenating Southern California getaway.', '2023-06-18', '2023-06-18', 'https://www.planetware.com/wpimages/2023/05/california-los-angeles-top-attractions-santa-monica-bike-path-palms.jpg', '2023-06-21 11:11:11', NULL, 1, 1, 12);
INSERT INTO `blog` (`id`, `title`, `description`, `trip_start`, `trip_end`, `image_url`, `created_at`, `updated_at`, `enabled`, `user_id`, `place_id`) VALUES (13, 'A Wild Adventure: Exploring Taronga Zoo\'s Natural Wonderland', 'Nestled on the shores of Sydney Harbor, Taronga Zoo is a captivating haven where nature enthusiasts can embark on a thrilling journey to encounter a diverse array of wildlife. I recently had the opportunity to visit this iconic zoo and was immersed in a world of fascinating creatures and conservation efforts. Join me as I recount my unforgettable experience exploring Taronga Zoo and discovering the wonders of the animal kingdom.\n\nAwe-Inspiring Animal Encounters:\nFrom the moment I stepped foot inside Taronga Zoo, I was greeted by an awe-inspiring array of animals from around the globe. From majestic big cats like lions and tigers to adorable koalas and playful kangaroos, the zoo is home to over 4,000 animals representing various species. Witnessing these magnificent creatures up close, observing their behaviors, and learning about their habitats was a truly humbling experience that left me with a profound appreciation for the wonders of the natural world.\n\nConservation and Education:\nTaronga Zoo is not just a place for entertainment but also a center for conservation and education. The zoo actively participates in breeding programs for endangered species and supports wildlife conservation initiatives globally. Through informative signage, interactive exhibits, and educational presentations, visitors gain a deeper understanding of the importance of wildlife preservation and the steps we can take to protect our planet\'s biodiversity. It was inspiring to witness Taronga Zoo\'s commitment to creating a sustainable future for all species.\n\nWildlife in Naturalistic Settings:\nOne aspect that sets Taronga Zoo apart is its commitment to providing animals with naturalistic and spacious habitats. The zoo\'s enclosures are designed to mimic the animals\' natural environments, ensuring their well-being and allowing visitors to observe them in settings that closely resemble their native habitats. From the lush rainforests of the Lemur Forest to the rugged Outback Trail, each section of the zoo offers a unique and immersive experience that transports visitors to different corners of the world.\n\nSky Safari and Scenic Views:\nAn added highlight of my visit was the Sky Safari, a cable car ride that provides breathtaking panoramic views of Sydney Harbor while gliding over the zoo. The aerial journey offers a unique perspective, allowing visitors to appreciate the beauty of the zoo\'s surroundings and catch glimpses of some of the animal enclosures from above. The Sky Safari provides a serene and picturesque interlude amidst the bustling zoo, offering a moment of tranquility and a chance to soak in the stunning harbor views.\n\nEngaging Animal Encounters and Keeper Talks:\nTaronga Zoo offers a range of immersive experiences, including up-close encounters and keeper talks. These interactive sessions allow visitors to learn more about specific animals, their behaviors, and the conservation efforts being undertaken to protect their species. From feeding giraffes and patting kangaroos to watching elephants showcase their intelligence, these experiences provide a deeper connection with the animal residents and create lasting memories.\n\nConclusion:\nA visit to Taronga Zoo is not just a day of animal appreciation but an opportunity to become a part of the ongoing efforts to protect and conserve wildlife. The zoo\'s commitment to conservation, engaging exhibits, and immersive encounters create a truly remarkable experience for visitors of all ages. Taronga Zoo\'s mission to inspire love for wildlife and foster a sense of responsibility for our natural world is evident at every turn. Whether you are a nature enthusiast, a wildlife lover, or simply seeking a unique adventure, a trip to Taronga Zoo promises an unforgettable journey through the wonders of the animal kingdom.', '2023-05-05', '2023-05-06', 'https://i.guim.co.uk/img/media/b3121d3048e54f35ff1e7ec83b4822ccd4989856/0_67_5568_3341/master/5568.jpg?width=1300&quality=45&dpr=2&s=none', '2023-06-22 13:33:22', NULL, 1, 2, 13);
INSERT INTO `blog` (`id`, `title`, `description`, `trip_start`, `trip_end`, `image_url`, `created_at`, `updated_at`, `enabled`, `user_id`, `place_id`) VALUES (14, 'Saint Basil\'s Cathedral: A Storied Journey through Moscow\'s Architectural Jewel', 'A Marvel of Architectural Ingenuity:\nSaint Basil\'s Cathedral, with its intricate onion domes and vibrant colors, is an architectural marvel that has captivated visitors for centuries. As I approached the cathedral, I was mesmerized by the sheer beauty of its unique design. Each of the nine chapels represents a different era in Russian history, and the harmonious blending of shapes and colors creates a visual spectacle that is both harmonious and striking.\n\nStepping into History:\nWalking through the cathedral\'s entrance, I was immediately immersed in a world steeped in history. The interior of Saint Basil\'s Cathedral is adorned with ornate frescoes, religious icons, and breathtakingly detailed artworks. The candlelit ambiance and the scent of incense added to the atmosphere of reverence, transporting me to a time when the cathedral was a center of religious and cultural life in Moscow.\n\nThe Legend of Ivan the Terrible:\nSaint Basil\'s Cathedral owes its name to the holy fool Basil the Blessed, whose tomb lies within its walls. Legend has it that Ivan the Terrible was so awestruck by the cathedral\'s beauty that he ordered its creator, Postnik Yakovlev, to be blinded to prevent him from replicating such a masterpiece elsewhere. This captivating tale adds a layer of intrigue to the cathedral\'s history and further deepens its allure.\n\nPanoramic Views from the Bell Tower:\nFor those seeking breathtaking views of Moscow, ascending the bell tower of Saint Basil\'s Cathedral is an absolute must. Climbing the narrow staircases, I reached the top to be greeted by a panoramic vista of the city. The sprawling Red Square, the Kremlin\'s majestic walls, and the bustling streets of Moscow unfolded before my eyes, offering a unique perspective and a perfect opportunity for memorable photographs.\n\nA Cultural Icon:\nSaint Basil\'s Cathedral transcends its architectural significance to become a cultural icon that represents the soul of Russia. Its image has graced countless postcards, paintings, and photographs, serving as a symbol of the country\'s rich heritage. The cathedral\'s inclusion on the UNESCO World Heritage list further highlights its universal importance as a treasure of human civilization.\n\nConclusion:\nVisiting Saint Basil\'s Cathedral is an extraordinary journey into the heart of Russian history and culture. Its intricate design, captivating legends, and spiritual ambiance make it an architectural masterpiece unlike any other. Stepping inside the cathedral and witnessing its breathtaking beauty was a profound experience that left an indelible impression on me. Saint Basil\'s Cathedral stands as a testament to the creative genius of its builders and serves as a tangible link to Russia\'s glorious past. For anyone traveling to Moscow, a visit to this iconic landmark is an opportunity to immerse oneself in the country\'s rich heritage and behold the timeless allure of Saint Basil\'s Cathedral.', '2023-06-01', '2023-06-02', 'https://gallerybyzantium.com/wp-content/uploads/2019/01/st-basil-cathedral_1.jpg', '2023-06-20 14:45:32', NULL, 1, 3, 14);
INSERT INTO `blog` (`id`, `title`, `description`, `trip_start`, `trip_end`, `image_url`, `created_at`, `updated_at`, `enabled`, `user_id`, `place_id`) VALUES (15, 'Reaching New Heights: Conquering the Majestic Table Mountain in South Africa', 'Table Mountain, an iconic landmark overlooking the vibrant city of Cape Town, South Africa, is a hiker\'s paradise and a nature lover\'s dream. Recently, I embarked on an exhilarating journey to summit this majestic peak, immersing myself in breathtaking landscapes and forging unforgettable memories along the way. Join me as I recount my awe-inspiring experience hiking up Table Mountain, a true testament to the raw beauty of South Africa\'s natural wonders.\n\nAwe-Inspiring Landscapes:\nAs I began my ascent up Table Mountain, I was immediately struck by the stunning landscapes that unfolded before my eyes. Towering cliffs, verdant slopes, and dramatic rock formations painted a picture-perfect canvas. The rugged beauty of the mountain, coupled with panoramic views of Cape Town and the vast expanse of the Atlantic Ocean, created a sense of wonder and appreciation for the natural wonders of South Africa.\n\nMultiple Hiking Routes:\nTable Mountain offers a range of hiking routes suited for different fitness levels and preferences. I chose the popular Platteklip Gorge trail, a challenging but rewarding path that led me through a steep ascent, with rocky terrain and breathtaking vistas at every turn. The diversity of flora and fauna, from fynbos vegetation to colorful bird species, added to the enchantment of the hike.\n\nNature\'s Bounty: Flora and Fauna:\nTable Mountain is renowned for its rich biodiversity, with thousands of plant species found nowhere else on Earth. Throughout the hike, I encountered a stunning variety of fynbos, a unique vegetation type that contributes to the mountain\'s status as a UNESCO World Heritage site. The melodious calls of native bird species, such as the Cape Sugarbird and the Orange-breasted Sunbird, further enhanced the immersive experience in nature\'s embrace.\n\nA Thrilling Cableway Ride:\nFor those seeking an alternative to hiking, the Table Mountain Aerial Cableway offers a thrilling and convenient option. After descending from the summit, I decided to indulge in a cableway ride back to the base. The state-of-the-art cable car provided awe-inspiring 360-degree views of the mountain and its surroundings, offering a different perspective on the grandeur of Table Mountain.\n\nThe Reward: Spectacular Views from the Summit:\nReaching the summit of Table Mountain was a triumphant moment that rewarded me with unparalleled views. The vastness of Cape Town, stretching to the glistening Atlantic Ocean, was a sight to behold. The iconic Twelve Apostles mountain range and the rugged coastline added to the breathtaking panorama. I found solace in taking a moment to absorb the splendor of the scene, realizing the magnitude of the accomplishment and feeling at one with the captivating beauty of nature.\n\nConclusion:\nHiking up Table Mountain in South Africa is a soul-stirring experience that immerses adventurers in the captivating landscapes of this iconic natural wonder. From the awe-inspiring vistas to the rich biodiversity and the sense of accomplishment upon reaching the summit, the journey offers a deep connection with the breathtaking beauty of the region. Whether you choose to tackle the challenging trails or opt for a scenic cableway ride, Table Mountain promises an unforgettable adventure that will leave you with lasting memories and a profound appreciation for the wonders of South Africa\'s natural landscapes.', '2023-06-29', '2023-06-29', 'https://cdn.audleytravel.com/1050/750/79/435256-view-from-the-table-mountain-cable-car-cape-town.webp', '2023-06-29 18:55:45', NULL, 1, 3, 15);
...
INSERT INTO `place_image` (`id`, `image_url`, `enabled`, `place_id`, `user_id`, `created_at`, `updated_at`) VALUES (11, 'https://a.cdn-hotels.com/gdcs/production36/d108/408bdddc-2a55-49ab-89c1-cc4546026060.jpg?impolicy=fcrop&w=1600&h=1066&q=medium', 1, 1, 1, '2023-06-21 11:11:11', NULL);
